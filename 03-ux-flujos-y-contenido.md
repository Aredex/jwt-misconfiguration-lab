...
El visitante ve un fixture precargado, un texto breve sobre privacidad y el CTA **“Ejecutar escenario”**. La aplicación realiza: seleccionar un token ficticio y observar cada validación y su fallo.
...
```text
+----------------------------------------------------------+
| JWT Misconfiguration Lab                         [Privacidad]  |
