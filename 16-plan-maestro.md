...
**Proyecto:** 11. jwt-misconfiguration-lab — **Decisión:** GO · **Horas MVP:** 8–12h · **Modo:** estático

## Objetivo

Seleccionar un token JWT ficticio y observar cada validación (exp/nbf/iss/aud/algoritmo) y su fallo.

## Mapeo de requisitos a fases

- **F1 (corte vertical principal):** decodificar tokens ficticios · validar exp/nbf/iss/aud.
- **F2 (robustez del dominio):** detectar algoritmos y claves inválidos · explicar sin exponer secretos.

## Riesgo a vigilar especialmente

(Alto) Usuarios pegando tokens reales / mensaje que sugiera seguridad completa → aviso previo explícito + evitar lenguaje de certificación.
