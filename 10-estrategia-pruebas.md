...
| --------- | -------- | ------------ | --------------- | ------- | ---------------- |
| P11-R1    | `unit-1` | `contract-1` | `integration-1` | `e2e-1` | captura + export |
| P11-R2    | `unit-2` | `contract-2` | `integration-2` | `e2e-2` | captura + export |
| P11-R3    | `unit-3` | `contract-3` | `integration-3` | `e2e-3` | captura + export |
| P11-R4    | `unit-4` | `contract-4` | `integration-4` | `e2e-4` | captura + export |
